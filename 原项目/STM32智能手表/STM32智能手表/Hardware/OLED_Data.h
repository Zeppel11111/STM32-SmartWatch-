...
extern const uint8_t Timer[][32];
extern const uint8_t Menu[][128];
extern const uint8_t Diom[][48];
extern const uint8_t Enemy[][28];
extern const uint8_t Chosen[];
extern const uint8_t Battery[];
extern const uint8_t Ground[];
extern const uint8_t Cloud[];
extern const uint8_t Love[][512];
